...
{
    class E_Administrativo : Empleado  //Hereda las variables de la clase Empleado
    {
        ...
        public E_Administrativo()
        {
            ...
            Console.Write("REGISTRO EMPLEADO ADMINISTRATIVO");
            Console.Write("\nIngrese nombre: ");
            ...
            Bono = Salario * 0.25; //Calculo adicional
